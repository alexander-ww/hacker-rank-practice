...
class Result {
    ...
    public static List<Integer> rotateLeft(int d, List<Integer> arr) {
        ...
        int i = 0;
        int n = arr.size();
        Integer temporary1 = Integer.valueOf(0);
        Integer temporary2 = Integer.valueOf(0);
        int iterations = 0;
        ...
        while (iterations < n) {
            ...
            if (iterations == 0 || started) {
                temporary1 = arr.get(rotated);
                arr.remove(rotated);
                arr.add(rotated, arr.get(i));
                started = false;
            }
             ...
             */
                ...
                temporary2 = arr.get(rotated);
                arr.remove(rotated);
                arr.add(rotated, temporary1);
     ...
     * - O(1) space
     */
     private static int rotatedIndex(int i, int d, int n) {
